<%@page import="com.gojjam.bank.model.AuditLog"%>
<%@ page contentType="text/html;charset=UTF-8" language="java"
         import="com.gojjam.bank.model.AuditLog,java.util.List,
...
<div class="main-content">
  <header class="topbar">
    <div class="topbar-title"><i class="bi bi-journal-text"></i> System Audit Logs</div>
  ...
  <div class="page-content">
    <div class="alert-bank alert-info">
      ...
      Viewing last 200 audit entries. All actions are stored for minimum 5 years.
    </div>
      ...
      <div class="bank-card-body" style="padding:0;">
        <% if (logs == null || logs.isEmpty()) { %>
          <div style="padding:2rem;text-align:center;color:#6c757d;">
            ...
            <p style="margin-top:0.5rem;">No audit logs found.</p>
          </div>
        <% } else { %>
            ...
            <table class="bank-table">
              <thead>
                <tr>
                  ...
                  <th>IP Address</th><th>Old Value</th>
                  <th>New Value</th><th>Timestamp</th>
                </tr>
              </thead>
              <tbody>
                <% for (AuditLog log : logs) { %>
                  <tr>
                    ...
                    <td style="font-size:0.82rem;max-width:240px;
                    ...
                    <td style="font-size:0.78rem;color:#28a745;
                               max-width:100px;overflow:hidden;text-overflow:ellipsis;">
